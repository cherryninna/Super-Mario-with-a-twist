...
namespace ProjectVp
{
    public partial class Form1 : Form
    {
        ...
        private void timer_Anim_Tick(object sender, EventArgs e)
        {
            ...
            label_Bombs.Text = "Bombs: " + GetBombsNum(Bombs); //Sets the number of bombs label
            label_Highscore.Text = "Highscore: " + Properties.Settings.Default.Highscore;
        ...
        private void WorldFloor_Paint(object sender, PaintEventArgs e)
        {
